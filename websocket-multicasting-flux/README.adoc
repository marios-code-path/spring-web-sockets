...
== WebSocket Server
Spring's reactive WebSocket API is a part of Spring 5's WebFlux API. This enables reactive event and connection handling. We will introduce a single WebSocket handler, and show whats needed to get started using Spring's `WebSocketServer` support.
